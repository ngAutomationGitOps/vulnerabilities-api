...
from app.api.routes.asm_routes import asm_routes
from fastapi import HTTPException

def register_routes(app: FastAPI):
    all_routes = primary_routes + stats_routes +wazuh_events_routes + suri_events_routes + agents_routes + asm_routes
