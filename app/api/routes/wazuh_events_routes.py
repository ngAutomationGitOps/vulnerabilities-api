from app.api.handlers.wazuh_events_handlers import get_wazuh_events_count_handler , get_user_count_handler , get_events_by_user_handler,get_events_by_srcip_handler,get_events_by_status_handler, get_events_by_dept_handler,get_events_map_handler
