...
from app.api.services.primary_services import get_fim_count , get_fim_event_counts_service
...
async def get_fim_events_handler(db: AsyncSession = Depends(get_db)):
